...
export function PDFViewer({ doc, onBack, searchContext }: PDFViewerProps) {
  ...
  return (
    <div className="h-screen flex flex-col bg-background">
      {/* Top bar */}
      <header className="border-b border-border shrink-0 glass mt-[20px] sm:mt-0 md:mt-[20px] lg:mt-0">
        <div className="h-14 md:h-[36px] flex items-center justify-between px-2 sm:px-4">
